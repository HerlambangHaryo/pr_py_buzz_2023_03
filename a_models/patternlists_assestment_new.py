...
def paN_get_fixtures_only_ends(
            leagueapi_id,  
            pre_ah_pattern,  
            pre_gou_pattern, 
            end_ah_pattern,  
    ...
    space += "__"
    # ---------------------------------------------------------- 
    print(space + "paN_get_fixtures_only_ends()", flush=True)
    # ----------------------------------------------------------  
    host="localhost"
    user="root" 
...
def paN_get_fixtures_pre_ends(
    ...
    space += "__"
    # ---------------------------------------------------------- 
    print(space + "paN_get_fixtures_pre_ends()", flush=True)
    # ----------------------------------------------------------  
    host="localhost"
    user="root" 
    database="pr_mmbuzz_2022_06"
...
def paN_final_assestment(myresult, 
                leagueapi_id,
                pre_ah_pattern, 
                pre_gou_pattern, 
                end_ah_pattern, 
    ...
    space += "__"
    # ---------------------------------------------------------- 
    print(space + "paN_final_assestment()", flush=True)
    # ----------------------------------------------------------  
    host="localhost"
    user="root" 
    database="pr_mmbuzz_2022_06"
    ...
    if(TABEL == 'football_pattern_only'):
        ...
        update_pattern_lists = "UPDATE `football_odds` SET "
        update_pattern_lists += "pattern_lists = 1 "
        update_pattern_lists += " where `leagueapi_id` = '"+str(leagueapi_id)+"' "
        update_pattern_lists += " and pre_ah_pattern = '"+str(pre_ah_pattern)+"' "   
        update_pattern_lists += " and pre_gou_pattern = '"+str(pre_gou_pattern)+"' "  
        update_pattern_lists += " and end_ah_pattern = '"+str(end_ah_pattern)+"' "   
        update_pattern_lists += " and end_gou_pattern = '"+str(end_gou_pattern)+"' "  
        # --------------------------------------------------  
        print(space + "update_pattern_lists ", flush=True)
        # --------------------------------------------------  
        mycursor.execute(update_pattern_lists)
        mydb.commit()     
        # --------------------------------------------------   
        # -------------------------------------------------- 
    # --------------------------------------------------
