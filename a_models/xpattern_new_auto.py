...
def xpNa_set_pattern(prep_col, min_standart, space):  
    # ----------------------------------------------------------   
    space += "__"
    # ---------------------------------------------------------- 
    print(space + "xpNa_set_pattern()") 
    # ----------------------------------------------------------  
    if(prep_col == "one_"):
        xprep_col = "end_"
    else:
    ...
    # ----------------------------------------------------------  
    query_1 += ", " + xprep_col + "asian_handicap_home_min_675"
    query_1 += ", " + xprep_col + "asian_handicap_away_min_675"
    query_1 += ", " + xprep_col + "asian_handicap_home_min_65"
    query_1 += ", " + xprep_col + "asian_handicap_away_min_65"
    query_1 += ", " + xprep_col + "asian_handicap_home_min_625"
    query_1 += ", " + xprep_col + "asian_handicap_away_min_625"
    query_1 += ", " + xprep_col + "asian_handicap_home_min_6"
    query_1 += ", " + xprep_col + "asian_handicap_away_min_6"
    # ----------------------------------------------------------  
    query_1 += ", " + xprep_col + "asian_handicap_home_min_575"
    query_1 += ", " + xprep_col + "asian_handicap_away_min_575"
    query_1 += ", " + xprep_col + "asian_handicap_home_min_55"
    query_1 += ", " + xprep_col + "asian_handicap_away_min_55"
    query_1 += ", " + xprep_col + "asian_handicap_home_min_525"
    query_1 += ", " + xprep_col + "asian_handicap_away_min_525"
    query_1 += ", " + xprep_col + "asian_handicap_home_min_5"
    query_1 += ", " + xprep_col + "asian_handicap_away_min_5"
    # ----------------------------------------------------------  
    query_1 += ", " + xprep_col + "asian_handicap_home_min_475"
    query_1 += ", " + xprep_col + "asian_handicap_away_min_475"
    query_1 += ", " + xprep_col + "asian_handicap_home_min_45"
    query_1 += ", " + xprep_col + "asian_handicap_away_min_45"
    query_1 += ", " + xprep_col + "asian_handicap_home_min_425"
    query_1 += ", " + xprep_col + "asian_handicap_away_min_425"
    query_1 += ", " + xprep_col + "asian_handicap_home_min_4"
    query_1 += ", " + xprep_col + "asian_handicap_away_min_4"
    # ----------------------------------------------------------  
    query_1 += ", " + xprep_col + "asian_handicap_home_min_375"
    query_1 += ", " + xprep_col + "asian_handicap_away_min_375"
    query_1 += ", " + xprep_col + "asian_handicap_home_min_35"
    query_1 += ", " + xprep_col + "asian_handicap_away_min_35"
    query_1 += ", " + xprep_col + "asian_handicap_home_min_325"
    query_1 += ", " + xprep_col + "asian_handicap_away_min_325"
    query_1 += ", " + xprep_col + "asian_handicap_home_min_3"
    query_1 += ", " + xprep_col + "asian_handicap_away_min_3"
    # ----------------------------------------------------------  
    query_1 += ", " + xprep_col + "asian_handicap_home_min_275"
    query_1 += ", " + xprep_col + "asian_handicap_away_min_275"
    query_1 += ", " + xprep_col + "asian_handicap_home_min_25"
    query_1 += ", " + xprep_col + "asian_handicap_away_min_25"
    query_1 += ", " + xprep_col + "asian_handicap_home_min_225"
    query_1 += ", " + xprep_col + "asian_handicap_away_min_225"
    query_1 += ", " + xprep_col + "asian_handicap_home_min_2"
    query_1 += ", " + xprep_col + "asian_handicap_away_min_2"
    # ----------------------------------------------------------  
    query_1 += ", " + xprep_col + "asian_handicap_home_min_175"
    query_1 += ", " + xprep_col + "asian_handicap_away_min_175"
    query_1 += ", " + xprep_col + "asian_handicap_home_min_15"
    query_1 += ", " + xprep_col + "asian_handicap_away_min_15"
    query_1 += ", " + xprep_col + "asian_handicap_home_min_125"
    query_1 += ", " + xprep_col + "asian_handicap_away_min_125"
    query_1 += ", " + xprep_col + "asian_handicap_home_min_1"
    query_1 += ", " + xprep_col + "asian_handicap_away_min_1"
    # ----------------------------------------------------------  
    query_1 += ", " + xprep_col + "asian_handicap_home_min_075"
    query_1 += ", " + xprep_col + "asian_handicap_away_min_075"
    query_1 += ", " + xprep_col + "asian_handicap_home_min_05"
    query_1 += ", " + xprep_col + "asian_handicap_away_min_05"
    query_1 += ", " + xprep_col + "asian_handicap_home_min_025"
    query_1 += ", " + xprep_col + "asian_handicap_away_min_025"
    query_1 += ", " + xprep_col + "asian_handicap_home_plus_0"
    query_1 += ", " + xprep_col + "asian_handicap_away_plus_0"
    # ----------------------------------------------------------  
    query_1 += ", " + xprep_col + "asian_handicap_home_plus_025"
    query_1 += ", " + xprep_col + "asian_handicap_away_plus_025"
    query_1 += ", " + xprep_col + "asian_handicap_home_plus_05"
    query_1 += ", " + xprep_col + "asian_handicap_away_plus_05"
    query_1 += ", " + xprep_col + "asian_handicap_home_plus_075"
    query_1 += ", " + xprep_col + "asian_handicap_away_plus_075"
    # ----------------------------------------------------------  
    query_1 += ", " + xprep_col + "asian_handicap_home_plus_1"
    query_1 += ", " + xprep_col + "asian_handicap_away_plus_1"
    query_1 += ", " + xprep_col + "asian_handicap_home_plus_125"
    query_1 += ", " + xprep_col + "asian_handicap_away_plus_125"
    query_1 += ", " + xprep_col + "asian_handicap_home_plus_15"
    query_1 += ", " + xprep_col + "asian_handicap_away_plus_15"
    query_1 += ", " + xprep_col + "asian_handicap_home_plus_175"
    query_1 += ", " + xprep_col + "asian_handicap_away_plus_175"
    # ----------------------------------------------------------  
    query_1 += ", " + xprep_col + "asian_handicap_home_plus_2"
    query_1 += ", " + xprep_col + "asian_handicap_away_plus_2"
    query_1 += ", " + xprep_col + "asian_handicap_home_plus_225"
    query_1 += ", " + xprep_col + "asian_handicap_away_plus_225"
    query_1 += ", " + xprep_col + "asian_handicap_home_plus_25"
    query_1 += ", " + xprep_col + "asian_handicap_away_plus_25"
    query_1 += ", " + xprep_col + "asian_handicap_home_plus_275"
    query_1 += ", " + xprep_col + "asian_handicap_away_plus_275"
    # ----------------------------------------------------------  
    query_1 += ", " + xprep_col + "asian_handicap_home_plus_3"
    query_1 += ", " + xprep_col + "asian_handicap_away_plus_3"
    query_1 += ", " + xprep_col + "asian_handicap_home_plus_325"
    query_1 += ", " + xprep_col + "asian_handicap_away_plus_325"
    query_1 += ", " + xprep_col + "asian_handicap_home_plus_35"
    query_1 += ", " + xprep_col + "asian_handicap_away_plus_35"
    query_1 += ", " + xprep_col + "asian_handicap_home_plus_375"
    query_1 += ", " + xprep_col + "asian_handicap_away_plus_375"
    # ----------------------------------------------------------  
    query_1 += ", " + xprep_col + "asian_handicap_home_plus_4"
    query_1 += ", " + xprep_col + "asian_handicap_away_plus_4"
    query_1 += ", " + xprep_col + "asian_handicap_home_plus_425"
    query_1 += ", " + xprep_col + "asian_handicap_away_plus_425"
    query_1 += ", " + xprep_col + "asian_handicap_home_plus_45"
    query_1 += ", " + xprep_col + "asian_handicap_away_plus_45"
    query_1 += ", " + xprep_col + "asian_handicap_home_plus_475"
    query_1 += ", " + xprep_col + "asian_handicap_away_plus_475"
    # ----------------------------------------------------------  
    query_1 += ", " + xprep_col + "asian_handicap_home_plus_5"
    query_1 += ", " + xprep_col + "asian_handicap_away_plus_5"
    query_1 += ", " + xprep_col + "asian_handicap_home_plus_525"
    query_1 += ", " + xprep_col + "asian_handicap_away_plus_525"
    query_1 += ", " + xprep_col + "asian_handicap_home_plus_55"
    query_1 += ", " + xprep_col + "asian_handicap_away_plus_55"
    query_1 += ", " + xprep_col + "asian_handicap_home_plus_575"
    query_1 += ", " + xprep_col + "asian_handicap_away_plus_575"
    # ----------------------------------------------------------  
    query_1 += ", " + xprep_col + "asian_handicap_home_plus_6"
    query_1 += ", " + xprep_col + "asian_handicap_away_plus_6"
    query_1 += ", " + xprep_col + "asian_handicap_home_plus_625"
    query_1 += ", " + xprep_col + "asian_handicap_away_plus_625"
    query_1 += ", " + xprep_col + "asian_handicap_home_plus_65"
    query_1 += ", " + xprep_col + "asian_handicap_away_plus_65"
    query_1 += ", " + xprep_col + "asian_handicap_home_plus_675"
    query_1 += ", " + xprep_col + "asian_handicap_away_plus_675"
    # ----------------------------------------------------------  
    query_1 += ", " + xprep_col + "goals_overunder_over_05"
    query_1 += ", " + xprep_col + "goals_overunder_under_05"
    query_1 += ", " + xprep_col + "goals_overunder_over_075"
    query_1 += ", " + xprep_col + "goals_overunder_under_075"
    # ----------------------------------------------------------  
    query_1 += ", " + xprep_col + "goals_overunder_over_10"
    query_1 += ", " + xprep_col + "goals_overunder_under_10"
    query_1 += ", " + xprep_col + "goals_overunder_over_125"
    query_1 += ", " + xprep_col + "goals_overunder_under_125"
    query_1 += ", " + xprep_col + "goals_overunder_over_15"
    query_1 += ", " + xprep_col + "goals_overunder_under_15"
    query_1 += ", " + xprep_col + "goals_overunder_over_175"
    query_1 += ", " + xprep_col + "goals_overunder_under_175"
    # ----------------------------------------------------------  
    query_1 += ", " + xprep_col + "goals_overunder_over_20"
    query_1 += ", " + xprep_col + "goals_overunder_under_20"
    query_1 += ", " + xprep_col + "goals_overunder_over_225"
    query_1 += ", " + xprep_col + "goals_overunder_under_225"
    query_1 += ", " + xprep_col + "goals_overunder_over_25"
    query_1 += ", " + xprep_col + "goals_overunder_under_25"
    query_1 += ", " + xprep_col + "goals_overunder_over_275"
    query_1 += ", " + xprep_col + "goals_overunder_under_275"
    # ----------------------------------------------------------  
    query_1 += ", " + xprep_col + "goals_overunder_over_30"
    query_1 += ", " + xprep_col + "goals_overunder_under_30"
    query_1 += ", " + xprep_col + "goals_overunder_over_325"
    query_1 += ", " + xprep_col + "goals_overunder_under_325"
    query_1 += ", " + xprep_col + "goals_overunder_over_35"
    query_1 += ", " + xprep_col + "goals_overunder_under_35"
    query_1 += ", " + xprep_col + "goals_overunder_over_375"
    query_1 += ", " + xprep_col + "goals_overunder_under_375"
    # ----------------------------------------------------------  
    query_1 += ", " + xprep_col + "goals_overunder_over_40"
    query_1 += ", " + xprep_col + "goals_overunder_under_40"
    query_1 += ", " + xprep_col + "goals_overunder_over_425"
    query_1 += ", " + xprep_col + "goals_overunder_under_425"
    query_1 += ", " + xprep_col + "goals_overunder_over_45"
    query_1 += ", " + xprep_col + "goals_overunder_under_45"
    query_1 += ", " + xprep_col + "goals_overunder_over_475"
    query_1 += ", " + xprep_col + "goals_overunder_under_475"
    # ----------------------------------------------------------  
    query_1 += ", " + xprep_col + "goals_overunder_over_50"
    query_1 += ", " + xprep_col + "goals_overunder_under_50"
    query_1 += ", " + xprep_col + "goals_overunder_over_525"
    query_1 += ", " + xprep_col + "goals_overunder_under_525"
    query_1 += ", " + xprep_col + "goals_overunder_over_55"
    query_1 += ", " + xprep_col + "goals_overunder_under_55"
    query_1 += ", " + xprep_col + "goals_overunder_over_575"
    query_1 += ", " + xprep_col + "goals_overunder_under_575"
    # ----------------------------------------------------------  
    query_1 += ", " + xprep_col + "goals_overunder_over_60"
    query_1 += ", " + xprep_col + "goals_overunder_under_60"
    query_1 += ", " + xprep_col + "goals_overunder_over_625"
    query_1 += ", " + xprep_col + "goals_overunder_under_625"
    query_1 += ", " + xprep_col + "goals_overunder_over_65"
    query_1 += ", " + xprep_col + "goals_overunder_under_65"
    query_1 += ", " + xprep_col + "goals_overunder_over_675"
    query_1 += ", " + xprep_col + "goals_overunder_under_675"
    # ----------------------------------------------------------  
    query_1 += ", " + xprep_col + "goals_overunder_over_70"
    query_1 += ", " + xprep_col + "goals_overunder_under_70"
    query_1 += ", " + xprep_col + "goals_overunder_over_75"
    query_1 += ", " + xprep_col + "goals_overunder_under_75"
    query_1 += ", " + xprep_col + "goals_overunder_over_85"
    query_1 += ", " + xprep_col + "goals_overunder_under_85"
    query_1 += ", " + xprep_col + "goals_overunder_over_95"
    query_1 += ", " + xprep_col + "goals_overunder_under_95"
    # ----------------------------------------------------------  
    query_1 += ", leagueapi_id"
    query_1 += " from football_odds "  

    if(prep_col == 'end_'):
        query_1 += " where end_response = 1 "  
        query_1 += " and fixture_status in ('Match Finished', 'Match Finished Ended') "  
    elif(prep_col == 'pre_'):
        query_1 += " where pre_response = 1 "   
    elif(prep_col == 'one_'):
        query_1 += " where one_response = 1 "    
    # ----------------------------------------------------------   
    mycursor = mydb.cursor()
    ...
    for rs1 in result: 
        ...
        if( asian_handicap_away_plus_4 is not None and asian_handicap_home_plus_4 is not None):
            ah_total_plus_mirror_4 = asian_handicap_away_plus_4 + asian_handicap_home_plus_4
            if(ah_total_plus_mirror_4 < min_standart):
                ah_pattern_mirror += "-4"
        ...
        if( asian_handicap_away_min_4 is not None and asian_handicap_home_min_4 is not None):
            ah_total_min_mirror_4 = asian_handicap_away_min_4 + asian_handicap_home_min_4
            if(ah_total_min_mirror_4 < min_standart):
                ah_pattern_mirror += "+4"
        ...
        if( asian_handicap_away_plus_675 is not None and asian_handicap_home_plus_675 is not None):
            ah_total_plus_675_mirror = asian_handicap_away_plus_675 + asian_handicap_home_plus_675
            if(ah_total_plus_675_mirror <= min_standart):
                ah_pattern_mirror_4 += "-675"

        if( asian_handicap_away_plus_65 is not None and asian_handicap_home_plus_65 is not None):
            ah_total_plus_65_mirror = asian_handicap_away_plus_65 + asian_handicap_home_plus_65
            if(ah_total_plus_65_mirror <= min_standart):
                ah_pattern_mirror_4 += "-65"

        if( asian_handicap_away_plus_625 is not None and asian_handicap_home_plus_625 is not None):
            ah_total_plus_625_mirror = asian_handicap_away_plus_625 + asian_handicap_home_plus_625
            if(ah_total_plus_625_mirror <= min_standart):
                ah_pattern_mirror_4 += "-625"

        if( asian_handicap_away_plus_6 is not None and asian_handicap_home_plus_6 is not None):
            ah_total_plus_6_mirror = asian_handicap_away_plus_6 + asian_handicap_home_plus_6
            if(ah_total_plus_6_mirror <= min_standart):
                ah_pattern_mirror_4 += "-6"

        if( asian_handicap_away_plus_575 is not None and asian_handicap_home_plus_575 is not None):
            ah_total_plus_575_mirror = asian_handicap_away_plus_575 + asian_handicap_home_plus_575
            if(ah_total_plus_575_mirror <= min_standart):
                ah_pattern_mirror_4 += "-575"

        if( asian_handicap_away_plus_55 is not None and asian_handicap_home_plus_55 is not None):
            ah_total_plus_55_mirror = asian_handicap_away_plus_55 + asian_handicap_home_plus_55
            if(ah_total_plus_55_mirror <= min_standart):
                ah_pattern_mirror_4 += "-55"

        if( asian_handicap_away_plus_525 is not None and asian_handicap_home_plus_525 is not None):
            ah_total_plus_525_mirror = asian_handicap_away_plus_525 + asian_handicap_home_plus_525
            if(ah_total_plus_525_mirror <= min_standart):
                ah_pattern_mirror_4 += "-525"

        if( asian_handicap_away_plus_5 is not None and asian_handicap_home_plus_5 is not None):
            ah_total_plus_5_mirror = asian_handicap_away_plus_5 + asian_handicap_home_plus_5
            if(ah_total_plus_5_mirror <= min_standart):
                ah_pattern_mirror_4 += "-5"

        if( asian_handicap_away_plus_475 is not None and asian_handicap_home_plus_475 is not None):
            ah_total_plus_475_mirror = asian_handicap_away_plus_475 + asian_handicap_home_plus_475
            if(ah_total_plus_475_mirror <= min_standart):
                ah_pattern_mirror_4 += "-475"

        if( asian_handicap_away_plus_45 is not None and asian_handicap_home_plus_45 is not None):
            ah_total_plus_45_mirror = asian_handicap_away_plus_45 + asian_handicap_home_plus_45
            if(ah_total_plus_45_mirror <= min_standart):
                ah_pattern_mirror_4 += "-45"

        if( asian_handicap_away_plus_425 is not None and asian_handicap_home_plus_425 is not None):
            ah_total_plus_425_mirror = asian_handicap_away_plus_425 + asian_handicap_home_plus_425
            if(ah_total_plus_425_mirror <= min_standart):
                ah_pattern_mirror_4 += "-425"

        if( asian_handicap_away_plus_4 is not None and asian_handicap_home_plus_4 is not None):
            ah_total_plus_4_mirror = asian_handicap_away_plus_4 + asian_handicap_home_plus_4
            if(ah_total_plus_4_mirror <= min_standart):
                ah_pattern_mirror_4 += "-4"

        if( asian_handicap_away_plus_375 is not None and asian_handicap_home_plus_375 is not None):
            ah_total_plus_375_mirror = asian_handicap_away_plus_375 + asian_handicap_home_plus_375
            if(ah_total_plus_375_mirror <= min_standart):
                ah_pattern_mirror_4 += "-375"

        if( asian_handicap_away_plus_35 is not None and asian_handicap_home_plus_35 is not None):
            ah_total_plus_35_mirror = asian_handicap_away_plus_35 + asian_handicap_home_plus_35
            if(ah_total_plus_35_mirror <= min_standart):
                ah_pattern_mirror_4 += "-35"

        if( asian_handicap_away_plus_325 is not None and asian_handicap_home_plus_325 is not None):
            ah_total_plus_325_mirror = asian_handicap_away_plus_325 + asian_handicap_home_plus_325
            if(ah_total_plus_325_mirror <= min_standart):
                ah_pattern_mirror_4 += "-325"

        if( asian_handicap_away_plus_3 is not None and asian_handicap_home_plus_3 is not None):
            ah_total_plus_3_mirror = asian_handicap_away_plus_3 + asian_handicap_home_plus_3
            if(ah_total_plus_3_mirror <= min_standart):
                ah_pattern_mirror_4 += "-3"

        if( asian_handicap_away_plus_275 is not None and asian_handicap_home_plus_275 is not None):
            ah_total_plus_275_mirror = asian_handicap_away_plus_275 + asian_handicap_home_plus_275
            if(ah_total_plus_275_mirror <= min_standart):
                ah_pattern_mirror_4 += "-275"

        if( asian_handicap_away_plus_25 is not None and asian_handicap_home_plus_25 is not None):
            ah_total_plus_25_mirror = asian_handicap_away_plus_25 + asian_handicap_home_plus_25
            if(ah_total_plus_25_mirror <= min_standart):
                ah_pattern_mirror_4 += "-25"

        if( asian_handicap_away_plus_225 is not None and asian_handicap_home_plus_225 is not None):
            ah_total_plus_225_mirror = asian_handicap_away_plus_225 + asian_handicap_home_plus_225
            if(ah_total_plus_225_mirror <= min_standart):
                ah_pattern_mirror_4 += "-225"

        if( asian_handicap_away_plus_2 is not None and asian_handicap_home_plus_2 is not None):
            ah_total_plus_2_mirror = asian_handicap_away_plus_2 + asian_handicap_home_plus_2
            if(ah_total_plus_2_mirror <= min_standart):
                ah_pattern_mirror_4 += "-2"

        if( asian_handicap_away_plus_175 is not None and asian_handicap_home_plus_175 is not None):
            ah_total_plus_175_mirror = asian_handicap_away_plus_175 + asian_handicap_home_plus_175
            if(ah_total_plus_175_mirror <= min_standart):
                ah_pattern_mirror_4 += "-175"

        if( asian_handicap_away_plus_15 is not None and asian_handicap_home_plus_15 is not None):
            ah_total_plus_15_mirror = asian_handicap_away_plus_15 + asian_handicap_home_plus_15
            if(ah_total_plus_15_mirror <= min_standart):
                ah_pattern_mirror_4 += "-15"

        if( asian_handicap_away_plus_125 is not None and asian_handicap_home_plus_125 is not None):
            ah_total_plus_125_mirror = asian_handicap_away_plus_125 + asian_handicap_home_plus_125
            if(ah_total_plus_125_mirror <= min_standart):
                ah_pattern_mirror_4 += "-125"

        if( asian_handicap_away_plus_1 is not None and asian_handicap_home_plus_1 is not None):
            ah_total_plus_1_mirror = asian_handicap_away_plus_1 + asian_handicap_home_plus_1
            if(ah_total_plus_1_mirror <= min_standart):
                ah_pattern_mirror_4 += "-1"

        if( asian_handicap_away_plus_075 is not None and asian_handicap_home_plus_075 is not None):
            ah_total_plus_075_mirror = asian_handicap_away_plus_075 + asian_handicap_home_plus_075
            if(ah_total_plus_075_mirror <= min_standart):
                ah_pattern_mirror_4 += "-075"

        if( asian_handicap_away_plus_05 is not None and asian_handicap_home_plus_05 is not None):
            ah_total_plus_05_mirror = asian_handicap_away_plus_05 + asian_handicap_home_plus_05
            if(ah_total_plus_05_mirror <= min_standart):
                ah_pattern_mirror_4 += "-05"

        if( asian_handicap_away_plus_025 is not None and asian_handicap_home_plus_025 is not None):
            ah_total_plus_025_mirror = asian_handicap_away_plus_025 + asian_handicap_home_plus_025
            if(ah_total_plus_025_mirror <= min_standart):
                ah_pattern_mirror_4 += "-025"

        if( asian_handicap_away_plus_0 is not None and asian_handicap_home_plus_0 is not None):
            ah_total_plus_0_mirror = asian_handicap_away_plus_0 + asian_handicap_home_plus_0
            if(ah_total_plus_0_mirror <= min_standart):
                ah_pattern_mirror_4 += "+0"
        ...
        # ------------------------------------------------------
        update_3 += " " + xprep_col + "ah_pattern = '" + ah_pattern + "',  "  
        update_3 += " " + xprep_col + "ah_pattern_mirror = '" + ah_pattern_mirror + "',  "  
        update_3 += " " + xprep_col + "gou_pattern = '" + gou_pattern + "',  "  
        # ------------------------------------------------------
        update_3 += " " + xprep_col + "ah_pattern_4 = '" + ah_pattern_4 + "',  "  
        update_3 += " " + xprep_col + "ah_pattern_mirror_4 = '" + ah_pattern_mirror_4 + "',  "  
        update_3 += " " + xprep_col + "gou_pattern_4 = '" + gou_pattern_4 + "'  "  
        # ------------------------------------------------------
        ...
        # ------------------------------------------------------ 
        print(space + " [" + str(counter) + "/"+ str(total_rows) + "]", flush=True)  
        # ------------------------------------------------------ 
        print(space + "  > fixtureapi_id = " + str(fixtureapi_id), flush=True)  
        # ------------------------------------------------------ 
        print(space + "  __> " + xprep_col + "ah_pattern = " + ah_pattern + "", flush=True)
        print(space + "  __> " +xprep_col + "ah_pattern_mirror = " + ah_pattern_mirror + "", flush=True)
        print(space + "  __> " +xprep_col + "gou_pattern = " + gou_pattern + "", flush=True)
        # ------------------------------------------------------
        print(space , flush=True)
        # ------------------------------------------------------
        print(space + "  __> " + xprep_col + "ah_pattern_4 = " + ah_pattern_4 + "", flush=True)
        print(space + "  __> " +xprep_col + "ah_pattern_mirror_4 = " + ah_pattern_mirror_4 + "", flush=True)
        print(space + "  __> " +xprep_col + "gou_pattern_4 = " + gou_pattern_4 + "", flush=True)
        # ------------------------------------------------------
        print(space , flush=True)
        # ------------------------------------------------------
        print(space + "  ____> football_odds update pattern commited", flush=True) 
        # ------------------------------------------------------
    # ---------------------------------------------------------- 
