        ...
        if(total_response == 0):
            ...
            for i in d['response']: 
                ...
                for sa in standing_Array:
                    ...
                    yes_no_check    = aFS_check(DICTleagueapi_id, DICTseason, teamapi_id, space)
                    # ----------------------------------------------------------
                    host="localhost"
                    user="root" 
                    database="pr_mmbuzz_2022_06"
                    ...
                    if(yes_no_check == 1):
                        ...
                        print(space + "api_football_standings UPDATED", flush=True)  

                    elif(yes_no_check == 0):
                        # ---------------------------------------------- 
                        query_commit = "INSERT INTO `api_football_standings`( "
                        # ---------------------------------------------- 
                        ...
                        # print(space + query_commit, flush=True)
                        print(space + "api_football_standings INSERTED", flush=True)
                    ...
                    # # ------------------------------------------------------  
                    ats_controll_match_update(DICT, "Null", space)
