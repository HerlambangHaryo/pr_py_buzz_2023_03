...
def xpN_get_league_fixture_to_reset(leagueapi_id, prep_col, min_standart, space):
    ...
    space += "__"
    # ---------------------------------------------------------- 
    print(space + "xpN_get_league_fixture_to_reset()", flush=True)
    # ----------------------------------------------------------    
    space += "__"
    # ----------------------------------------------------------  
    host="localhost"
    ...
    for x in result:    
        ...
        # ------------------------------------------------------
        xpN_set_pattern(fixtureapi_id, prep_col, min_standart, space)
        # ------------------------------------------------------
    # ---------------------------------------------------------- 
    # ---------------------------------------------------------- 

def xpN_set_pattern(fixtureapi_id, prep_col, min_standart, space):  
    # ----------------------------------------------------------   
    space += "__"
    # ---------------------------------------------------------- 
    print(space + "xpN_set_pattern()") 
    # ----------------------------------------------------------  
    host="localhost"
    user="root" 
    database="pr_mmbuzz_2022_06"
    ...
    for rs1 in result: 
        ...
        # ------------------------------------------------------
        update_3 += " " + prep_col + "ah_pattern = '" + ah_pattern + "',  "  
        update_3 += " " + prep_col + "ah_pattern_mirror = '" + ah_pattern_mirror + "',  "  
        update_3 += " " + prep_col + "gou_pattern = '" + gou_pattern + "'  "  
        ...
        # ------------------------------------------------------
        print(space + "> " + prep_col + "ah_pattern = " + ah_pattern + "", flush=True)
        print(space + "> " +prep_col + "ah_pattern_mirror = " + ah_pattern_mirror + "", flush=True)
        print(space + "> " +prep_col + "gou_pattern = " + gou_pattern + "", flush=True)
