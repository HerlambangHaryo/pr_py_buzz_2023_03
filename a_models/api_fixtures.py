...
def af_response_fixtures(DICT, ROUTES, APIkey, space): 
    ...
    if(ROUTES == 'fixtureapi_id'):
        ...
        xROUTES = 'leagueapi_id'
    elif(ROUTES == 'not_started_yet'):
        DICTfixtureapi_id = DICT['fixtureapi_id']
        querystring = {"id":DICTfixtureapi_id} 
        print(space + "ROUTES : fixtureapi_id", flush=True) 
        print(space + "fixtureapi_id : " + str(DICTfixtureapi_id), flush=True) 
        ...
        xROUTES = 'fixtureapi_id'
    elif(ROUTES == 'all_match'):
        print(space + "ROUTES : all_match", flush=True) 
        ...
        xROUTES = 'leagueapi_id'
    elif(ROUTES == 'Next14days'):
        print(space + "ROUTES : Next14days", flush=True) 
    ...
    # ---------------------------------------------------------- 
        for row in d['response']:
            ...
            # --------------------------------------------------
            print(space + "fixture_status: " +str(fixture_status), flush=True)
            # --------------------------------------------------
            ...
            if(good_to_go == 1):
                ...
                counter += 1
                # ----------------------------------------------  
                team_home_id = row['teams']['home']['id']
                team_away_id = row['teams']['away']['id']
                # ---------------------------------------------- 
                ...
                if(xROUTES == "fixtureapi_id"): 
                    ...
                    for rwln in row['lineups']:
                        ...
                        if(team_home_id == team_id): 
                            # print("")
                            # print("ID :" + str(team_home_id))
                            ...
                            if( lineups_formation_home is None):
                                lineups_formation_home = "Null"
                            # else: 
                                # print("lineups_formation_home :" + lineups_formation_home)

                        elif(team_away_id == team_id): 
                            # print("")
                            # print("ID :" + str(team_away_id))
                            ...
                            if( lineups_formation_away is None):
                                lineups_formation_away = "Null"
                            # else: 
                                # print("lineups_formation_away :" + lineups_formation_away)
                ...
                # ----------------------------------------------   
                word = space + "football_odds: " + str(counter) + ". /" 
                word += fixture_status + "/ "
                word += fixtureapi_id + " / "
                word += teams_home + " vs "
                word += teams_away + " /"
                ...
                if(len(result_check) > 0):
                    ...
                    if(xROUTES == "leagueapi_id"):   
                        ...
                        mydb.commit()  
                        # --------------------------------------  
                        print(space + "football_odds UPDATED", flush=True) 
                        # ------------------------------------------  
