...
def array_col_football_odds():
    acfo = [ 
        ...
        "end_anytime_goal_scorer",
        "pre_first_goal_scorer",
        "end_first_goal_scorer",
        "pre_last_goal_scorer",
        "end_last_goal_scorer",
        "pre_to_score_two_or_more_goals",
        "end_to_score_two_or_more_goals",
        "pre_last_goal_scorer2",
        "end_last_goal_scorer2",
        "pre_exact_score",
        "end_exact_score",
        "pre_player_to_be_booked",
        "end_player_to_be_booked",
        "pre_ah_pattern",
        ...
        "end_odd_updated_at",
        "pre_ah_pattern_4",
        "pre_ah_pattern_mirror_4",
        "pre_gou_pattern_4",
        "end_ah_pattern_4",
        "end_ah_pattern_mirror_4",
        "end_gou_pattern_4",
        "special_odds"
    ]
