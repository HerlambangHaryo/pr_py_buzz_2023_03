...
def xp4N_get_league_fixture_to_reset(leagueapi_id, prep_col, min_standart, space):
    # ----------------------------------------------------------   
    space += "__"
    # ---------------------------------------------------------- 
    print(space + "xp4N_get_league_fixture_to_reset()", flush=True)
    # ----------------------------------------------------------    
    space += "__"
    # ----------------------------------------------------------  
    host="localhost"
    ...
    for x in result:    
        ...
        # ------------------------------------------------------
        xp4N_set_pattern(fixtureapi_id, prep_col, min_standart, space)
        # ------------------------------------------------------
    # ---------------------------------------------------------- 
    # ---------------------------------------------------------- 

def xp4N_set_pattern(fixtureapi_id, prep_col, min_standart, space):  
    # ----------------------------------------------------------   
    space += "__"
    # ---------------------------------------------------------- 
    print(space + "xp4N_set_pattern()") 
    # ----------------------------------------------------------  
    host="localhost"
    user="root" 
    database="pr_mmbuzz_2022_06"
